...
:: Android packaging
set AND_CERT_NAME="FIELDMARSHAL"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\FIELDMARSHAL.p12
...
set IOS_PROVISION=cert\FIELDMARSHAL.mobileprovision
...
set APP_ID=air.FIELDMARSHAL

:: Output packages
set DIST_PATH=dist
set DIST_NAME=FIELDMARSHAL
